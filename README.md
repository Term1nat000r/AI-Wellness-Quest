...
Визуал приложения можно посмотреть [здесь](https://raw.githubusercontent.com/Term1nat000r/AI-Wellness-Quest/master/src/index.html) — откройте в любом браузере.
